...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value='328',
        description='Select world (map file, pcd file, share the same name prefix as the this parameter)')
    ...
    start_localization_group = GroupAction(
        ...
        actions=[
            ...
            IncludeLaunchDescription(
                ...
                condition = LaunchConfigurationNotEquals('localization', 'slam_toolbox'), # 当localization参数不是'slam_toolbox'时执行  
                launch_arguments={
                    'use_sim_time': use_sim_time,
                    'map': nav2_map_dir,
                    'params_file': nav2_params_file_dir,
